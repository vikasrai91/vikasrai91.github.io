...
if(isset($_GET["token"]) && isset($_GET["PayerID"]))
{
	...
	$GrandTotal 		= $_SESSION['ItemTotalPrice'];
				...
				*/
				...
				if("SUCCESS" == strtoupper($httpParsedResponseAr["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($httpParsedResponseAr["ACK"])) 
				{
					...
					*/
					...
					mysql_query("insert into d_payments(user_id,plan_id,amount,datetime) values(".$_SESSION['user_id'].",'1','$ItemTotalPrice','$datetime')");
